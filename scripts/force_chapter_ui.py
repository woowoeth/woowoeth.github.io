...
HWX_INTROS = {
    "herbert-simon": "拿过图灵奖、也拿过诺贝尔经济学奖的学者，一辈子在问人实际上怎么做决定——他的答案是没有人真在挑最好的，都在找第一个够好的；而信息一多，最先不够用的是注意力",
    "liji": "西汉戴圣编定的四十九篇儒家礼文——我们不取它的仪节，取夹在仪节中间讲分寸的三处：一张一弛，嗟来之食，开而弗达",
    "lin-xiangru": "战国赵国的上卿，完璧归赵、在渑池逼秦王击缻的那个人——他对强敌寸步不让，回到赵国却一路躲着同僚廉颇；他的硬和他的让，算的是同一笔账",
    "cowan": "技术史学家，她问的是家里机器越来越多、家务为什么没少——答案是机器替掉的多半是帮手，省下的力气又被抬高的标准吃掉了",
    "lushi-chunqiu": "公元前三世纪吕不韦门客集撰的一部大书，十二纪八览六论——我们取它讲怎么看人、怎么核一句传来的话、怎么发现自己那份情况已经过期的那几篇",
    "yanshi-jiaxun": "六世纪末颜之推写给子孙的家训，二十篇——他把家当成一件要治的事：风化自上而行，规矩要趁早立，亲兄弟各自成家之后会自己变远",
    "becker": "经济学家，把「算账」推到经济学原来不管的地方——他算出上大学真正的开销里学费只占一成七，也算出公司抢着教你的那一半，正是你带不走的",
    "liu-yan": "唐代理财家，安史之乱后掌全国钱粮近二十年，靠一张报价网「如见钱流地上」，又只把沾钱的事交给有前程的人",
    "bai-juyi": "唐代诗人，五十八岁给自己挑了个有俸禄没公事的闲职，写下「中隐」——不卷和退出之间的第三档",
    "axelrod": "政治学家，办过两场计算机竞赛，赢的是四行代码的「以牙还牙」——从不先动手，被坑了回敬一次就立刻回来",
    "merton": "社会学家，给出了「自证预言」和「马太效应」两个名字——怀疑会自己造出证据，承认会按名气发放",
    "kindleberger": "把三百年的金融疯狂排成一张表的经济学家，他说燃料从来是信贷，不是乐观",
    "parkinson": "研究英国海军史的人，从旧编制表里读出「工作会胀满时间、机构会自己长大」两条定律",
...
/* ── 今日三样 ── */
/* 「今日一句」先给**最新入库的那个人**的话，点「换一换」再进轮播。
   原来开局是 day%D.QP.length，一个纯轮播 —— 站里每天真加一个人，而首页
   两张写着「今日」的卡都指向三百多条里随机的某一条，新加的那个要等轮到。
   现在两张卡都先给新内容，而「换一换」把变化留着 —— 想看别的按一下就有。
   找不到（新条目还没配上金句）就退回原来的轮播，不留空。 */
var qIdx=(function(){
  var newest=(D.E&&D.E.length)?D.E[D.E.length-1].n:'';
  for(var i=0;i<D.QP.length;i++){ if(D.QP[i].who===newest) return i; }
  return day%D.QP.length;
})(), q1=D.QP[qIdx];
