...
#hwx .tq .q{font-size:clamp(20px,3.6vw,26px);font-weight:700;line-height:1.85;margin-bottom:14px}
...
#hwx .hh{font-size:21px;font-weight:700;margin:24px 0 10px;letter-spacing:.03em;display:flex;justify-content:space-between;align-items:baseline}
...
#hwx .res .qzq{font-size:16px;font-weight:700;line-height:1.6;margin-bottom:4px}
...
#hwx .res a b{font-size:15px;font-weight:600}
...
#hwx .tabs2 button{border:none;background:transparent;padding:9px 20px;font-family:inherit;font-size:17px;font-weight:600;color:var(--muted);cursor:pointer;border-bottom:3px solid transparent;margin-bottom:-2px}
...
#hwx .pc b{font-size:19px;line-height:1.45}
...
#hwx .nc b{font-size:19px;line-height:1.45}
...
#hwx .kc .t{font-size:16.5px;font-weight:700;line-height:1.65;margin:9px 0 12px;flex:1;color:var(--ink)}
